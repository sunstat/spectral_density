...
if __name__ == "__main__":
    ...
    print(SpecUtil.generate_dis_Fourier_freq_index(11))
    print(SpecUtil.generate_dis_Fourier_freq_index(10))
    print(SpecUtil.index_to_freq(1, 11))
    w = SpecUtil.generate_dis_Fourier_coefs(SpecUtil.index_to_freq(1, 11), 11)
    print(w)
